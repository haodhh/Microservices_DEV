...
namespace MS.LoggingManagement.Data
{
    ...
    {
        private LoggingManagementDbContext _context;
        ...
        /// Database Context
        /// </summary>
        public LoggingManagementDbContext dbConnection
        {
            get { return _context; }
        }
        ...
        {
            _context = new LoggingManagementDbContext();
            return _context;
        }
        ...
        {
            _context = new LoggingManagementDbContext(connectionString);
        }

        public void OpenConnection(Object dbConnection)
        {
            _context = (LoggingManagementDbContext)dbConnection;
        }
