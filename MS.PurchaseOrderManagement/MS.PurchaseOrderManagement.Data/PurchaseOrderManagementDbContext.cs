...
namespace MS.PurchaseOrderManagement.Data
{
    public class PurchaseOrderManagementDbContext : DbContext
    {
        ...
        public PurchaseOrderManagementDbContext(DbContextOptions<PurchaseOrderManagementDbContext> options) : base(options)
        {
        }

        public PurchaseOrderManagementDbContext()
        {
        }

        public PurchaseOrderManagementDbContext(string connectionString)
        {
