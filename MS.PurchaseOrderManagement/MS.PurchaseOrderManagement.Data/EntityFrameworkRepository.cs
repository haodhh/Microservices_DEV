...
namespace MS.PurchaseOrderManagement.Data
{
    ...
    {
        private PurchaseOrderManagementDbContext _context;
        ...
        /// Database Context
        /// </summary>
        public PurchaseOrderManagementDbContext dbConnection
        {
            get { return _context; }
        }
        ...
        {
            _context = new PurchaseOrderManagementDbContext();
            return _context;
        }

        public void OpenConnection(string connectionString)
        {
            _context = new PurchaseOrderManagementDbContext(connectionString);
        }

        public void OpenConnection(Object dbConnection)
        {
            _context = (PurchaseOrderManagementDbContext)dbConnection;
        }
