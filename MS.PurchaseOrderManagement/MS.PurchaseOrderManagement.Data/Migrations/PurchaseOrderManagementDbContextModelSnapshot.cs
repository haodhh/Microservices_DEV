...
{
    [DbContext(typeof(PurchaseOrderManagementDbContext))]
    partial class PurchaseOrderManagementDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.PurchaseOrder", b =>
                {
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.PurchaseOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.PurchaseOrderNumberSequence", b =>
                {
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.PurchaseOrderStatus", b =>
                {
                    b.Property<int>("PurchaseOrderStatusId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.TransactionQueueInbound", b =>
                {
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.TransactionQueueInboundHistory", b =>
                {
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.TransactionQueueOutbound", b =>
                {
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.TransactionQueueOutboundHistory", b =>
                {
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.TransactionQueueSemaphore", b =>
                {
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.PurchaseOrder", b =>
                {
                    b.HasOne("MS.PurchaseOrderManagement.Data.Models.PurchaseOrderStatus", "PurchaseOrderStatus")
                        .WithMany()
                        .HasForeignKey("PurchaseOrderStatusId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MS.PurchaseOrderManagement.Data.Models.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("MS.PurchaseOrderManagement.Data.Models.PurchaseOrderDetail", b =>
                {
                    b.HasOne("MS.PurchaseOrderManagement.Data.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MS.PurchaseOrderManagement.Data.Models.PurchaseOrder", "PurchaseOrder")
