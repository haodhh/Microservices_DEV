...
{
    public class PurchaseOrderManagementRepository : EntityFrameworkRepository, IPurchaseOrderManagementRepository
    {
        /// <summary>
        ...
        public async Task<List<Supplier>> SupplierInquiry(int accountID, string supplierName, DataGridPagingInformation paging)
        {
            ...
            paging.TotalPages = Functions.CalculateTotalPages(numberOfRows, paging.PageSize);
