...
namespace MS.PurchaseOrderManagement.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PurchaseOrderManagementDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));

            services.AddTransient<IPurchaseOrderManagementRepository, PurchaseOrderManagementRepository>();

            services.AddTransient<IPurchaseOrderManagementService>(provider =>
            new PurchaseOrderManagementService(provider.GetRequiredService<IPurchaseOrderManagementRepository>(), connectionStrings));
