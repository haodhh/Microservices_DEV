...
namespace MS.SalesOrderManagement.MessageQueues
{
    public class MessageProcessing : IMessageQueueProcessing
    {
        ...
        public MessageProcessing(ISalesOrderManagementRepository repository)
        {
        ...
        private async Task InventoryShipped(TransactionQueueInbound transaction)
        {
            ...
            SalesOrderDetail salesOrderDetail = await _repository.GetSalesOrderDetailForUpdate(payload.MasterEntityId);
