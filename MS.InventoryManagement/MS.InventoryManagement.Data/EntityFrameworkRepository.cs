...
namespace MS.InventoryManagement.Data
{
    ...
    public class EntityFrameworkRepository : IDataRepository, IDisposable
    {
        ...
        /// </summary>
        public InventoryManagementDbContext dbConnection
        {
            get { return _context; }
        }
        ...
        {
            _context = (InventoryManagementDbContext)dbConnection;
        }
        ...
        {
            _context = new InventoryManagementDbContext(connectionString);
        }
