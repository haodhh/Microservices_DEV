...
namespace MS.AccountManagement.Data
{
    ...
    {
        private AccountManagementDbContext _context;
        ...
        /// Database Context
        /// </summary>
        public AccountManagementDbContext dbConnection
        {
            get { return _context; }
        }
        ...
        {
            _context = new AccountManagementDbContext();
            return _context;
        }

        public void OpenConnection(Object dbConnection)
        {
            _context = (AccountManagementDbContext)dbConnection;
        }
        ...
        {
            _context = new AccountManagementDbContext(connectionString);
        }
